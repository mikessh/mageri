...
import com.milaboratory.oncomigec.core.consalign.processor.ConsensusOverlapper;
...
public class OverlapTest {
    ...
    public void positiveTest() throws Exception {
        ConsensusOverlapper ro = new ConsensusOverlapper();
        ...
        for (int i = 0; i < total; i++) {
            ...
            ConsensusOverlapper.OverlapResult result = ro.overlap(r1, r2);

            NucleotideSequence overlappedSequence = result.getConsensus1().getSequence().
    ...
    public void readThroughTest() {
        ...
        for (int i = 0; i < total; i++) {
            ...
            if (result.getConsensus1().getSequence().concatenate(result.getConsensus2().getSequence()).equals(fragment))
                overlappedT++;
