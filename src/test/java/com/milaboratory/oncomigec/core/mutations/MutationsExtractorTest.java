...
/*
    ...
    public void randomizedConsistencyIndelExomeTest() {
        ...
        for (int i = 0; i < nRepetiotions1; i++) {
            ...
            ExtendedKmerAligner aligner = new ExtendedKmerAligner(library);
            ...
            for (int j = 0; j < nRepetiotions2; j++) {
                ...
                if (consensus != null) {
                    ...
                    if (result != null) {
                        ...
                        int[] observedMajors = mutationsExtractor.computeMajorMutations().getMutationCodes(),
                        ...
                        Set<Integer> observedMinors = mutationsExtractor.backAlignReads().getCodes(),
    ...
    public void filterSubstitutionByQualTestNoIndels() {
        ...
        for (int i = 0; i < nRepetiotions2; i++) {
            ...
            if (consensus != null) {
                ...
                NucleotideSequence reference = consensus.getConsensusSQPair().getSequence();
                ...
                for (NucleotideSQPair read : consensus.getAssembledReads()) {
                    ...
                    if (hit != null) {
                        ...
                        int[] rawMutations = MutationsExtractor.computeMajorMutations(
                                read.getQuality(),
                                MutationsExtractor.computeMutations(reference, alignment),
                                alignment, (byte) 20);
